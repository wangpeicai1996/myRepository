				...
				<form action="${pageContext.request.contextPath}/order" id="orderForm" method="post"class="form-horizontal" style="margin-top:5px;margin-left:150px;">
					...
					<div class="form-group">
						...
						<c:if test="${not empty order.address}">
							<input type="text" name="address" class="form-control" id="address" value="${order.address}" placeholder="请输入收货地址">
						</c:if>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<input type="text" class="form-control" name="name" id="name" value="${order.name}" placeholder="请输收货人">
							</c:if>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<c:if test="${empty order.telephone}">
							<input type="text" name="telephone" class="form-control" id="telephone" placeholder="请输入联系方式">
							</c:if>
							<c:if test="${not empty order.telephone}">
							<input type="text" name="telephone" class="form-control" id="telephone" value="${order.telephone}" placeholder="请输入联系方式">
							</c:if>
