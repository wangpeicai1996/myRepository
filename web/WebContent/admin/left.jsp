...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010101','0101','用户管理','${pageContext.request.contextPath}/adminUser?method=findAllUser&pageNumber=1','','mainFrame');
		...
		d.add('010502','0105','付款未发订单','${pageContext.request.contextPath}/adminOrder?method=findAllByState&state=1&pageNumber=1','','mainFrame');
		...
		d.add('010505','0105','已完成订单','${pageContext.request.contextPath}/adminOrder?method=findAllByState&state=4&pageNumber=1','','mainFrame');
		document.write(d);
